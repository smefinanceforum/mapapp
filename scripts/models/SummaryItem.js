        ...
        function SummaryItem(msmeData, indData, type) {
            ...
            switch (type) {
                case 'country':
                    ...
                    this.PosTerminals = this.parseIntValue(this.indData[7]);
                    ...
                    this.LiteracyRate = this.parseIntValue(this.indData[19]);
                    this.DepositIr = this.parseFloatValue(this.indData[20]);
                    this.Unemployment = this.parseIntValue(this.indData[21]);
